...
-- Installs the complete table schemas and disables RLS on all tables for development.
...
-- 2. Disable Row Level Security (RLS) on all tables for public development access
